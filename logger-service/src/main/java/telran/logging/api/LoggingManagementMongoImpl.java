...
import telran.logging.controllers.LoggerRestController;
...
import telran.logging.repo.LoggerRepository;
...
public class LoggingManagementMongoImpl implements LoggingManagement {
    ...
    private Logger toLogger(LogDto logDto) {
        return new Logger(logDto.dateTime, logDto.isException,logDto.exceptionType,logDto.methodName,logDto.className,logDto.responseTime,logDto.result);
    }
